...
User.create(first_name: "Paul", last_name: "Bismuth", email: "bismuth5@example.com", password: "bismuth5@example.com", password_confirmation: "bismuth5@example.com", phone_number: "0606060606", address: "6, rue du Faucon, 75011 Paris", crypto_balance: 10000, euro_balance: 10000)

helen = User.find_by(email: "bismuth5@example.com")
